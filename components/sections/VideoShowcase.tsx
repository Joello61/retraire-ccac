    ...
    <section className="section-light py-20">
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
              ...
              <div className="phone-screen">
                ...
                <div className="w-full h-full flex flex-col items-center justify-center gap-4 bg-brand-blue px-6 text-center">
                  ...
                  <p className="text-brand-gold text-xs leading-snug">
                    Remplacez ce placeholder par votre video en modifiant le code ci-dessus
                  </p>
                </div>
          ...
          >
            Pour ajouter votre video : placez votre fichier video dans /public/videos/ et decommenter le code video
          </motion.p>
        </motion.div>
      </div>
    </section>
